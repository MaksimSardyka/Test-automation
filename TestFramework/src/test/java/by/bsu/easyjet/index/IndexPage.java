...
public class IndexPage {
    ...
    @FindBy(xpath = "//h2[@id='drawer-title-more-infants-than-adults']")
    private WebElement maxInfantPerAdultWarningDrawer;

    public boolean isMaxInfantPerAdultWarningDrawerVisible() {
        new WebDriverWait(driver, timeout).until(ExpectedConditions.visibilityOf(maxInfantPerAdultWarningDrawer));
        return maxInfantPerAdultWarningDrawer.isDisplayed();
    }
